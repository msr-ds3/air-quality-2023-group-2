...
plot_list <- lapply(df_list, function(data) {
  ggplot(data, aes(x = agg_mean, fill = before_2020)) +
    ...
    geom_vline(data = subset(data, !before_2020), aes(xintercept = med), color = "red", size = 1) +
    geom_vline(data = subset(data, before_2020), aes(xintercept = med), color = "blue", size = 1) +
    labs(
...
ggplot() +
  ...
  geom_point(data = df_no2_rel_change,
             ...
             pch = 1) +
  scale_color_gradient2(low = "purple4", high = "#FFA500") +
