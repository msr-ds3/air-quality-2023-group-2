...
# Filter the data for each parameter category
...
ggplot(data = df_no2, aes(y = countryCode, x = percent_change)) +
  geom_point() +
  labs(title = "Air Pollution by Country - no2",
       y = "Country",
       x = "Percent Change")

ggplot(data = df_o3, aes(y = countryCode, x = percent_change)) +
  geom_point() +
  labs(title = "Air Pollution by Country - o3",
       y = "Country",
       x = "Percent Change")

ggplot(data = df_pm25, aes(y = countryCode, x = percent_change)) +
  geom_point() +
